...
public interface DiamondManager {
    ...
    String getAvailableConfigureInfomation();
    ...
    String getAvailableConfigureInfomationFromSnapshot();
    ...
    Properties getPropertiesConfigureInfomation();
    ...
    Properties getAvailablePropertiesConfigureInfomationFromSnapshot();
    ...
    Properties getAvailablePropertiesConfigureInfomation();
