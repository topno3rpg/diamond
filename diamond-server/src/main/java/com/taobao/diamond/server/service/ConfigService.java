...
public class ConfigService {
    ...
    public void removeConfigInfo(long id, String userName, String actionType) {
        try {
    ...
    public void addConfigInfo(String dataId, String group, String content, String userName, String actionType) {
     ...
     * @param content
     */
    public void updateConfigInfo(String dataId, String group, String content, String userName, String actionType) {
        checkParameter(dataId, group, content);
        ConfigInfo configInfo = new ConfigInfo(dataId, group, content);
        // 先更新数据库，再更新磁盘
        try {
