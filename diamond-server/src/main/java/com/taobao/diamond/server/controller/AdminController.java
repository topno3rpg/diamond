...
public class AdminController extends BaseController {
    ...
    public String postConfig(HttpServletRequest request, HttpServletResponse response,
        ...
        this.configService.addConfigInfo(dataId, group, content, getCurrentUser(request), Constants.ADD_CONFIG);
    ...
    public String deleteConfig(HttpServletRequest request, HttpServletResponse response, @RequestParam("id") long id,
                               ModelMap modelMap) {
        // 删除数据
        this.configService.removeConfigInfo(id, getCurrentUser(request), Constants.DEL_CONFIG);
    ...
    public String reupload(HttpServletRequest request, HttpServletResponse response,
        ...
        this.configService.updateConfigInfo(dataId, group, content, getCurrentUser(request), Constants.UPDATE_CONFIG);
